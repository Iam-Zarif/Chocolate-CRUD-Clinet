...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.SECRET_KEY}@cluster0.ik2qndc.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    app.post("/chocolate/:id", async (req, res) => {
...
app.listen(port, () => {
  console.log(`chocolate running on port ${port}`);
});
